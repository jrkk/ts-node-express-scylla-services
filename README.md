# Express TypeScript Node ScyllaDB Services
...
- **Language**: TypeScript
- **Database Driver**: Cassandra Driver
- **Database**: ScyllaDB
- **Testing**: Mocha & Chai
...
```bash
git clone https://github.com/jrkk/ts-node-express-scylla-services.git
cd ts-node-express-scylla-services
```
